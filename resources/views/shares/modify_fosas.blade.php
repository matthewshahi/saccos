        ...
        <div class="col-md-12 mb-4">
            <div class="card text-start">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('modify.member.fosas') }}" method="POST" autocomplete="off">
                        @csrf
                                ...
                                <tbody>
                                    @for($i = 0; $i < $modify_member_shares_journal_entries; $i++)
                                        <tr>
                                            ...
                                            <td>
                                                <select name="fosa_action[]" class="form-control" required>
                                                    <option value="-1" {{ old('fosa_action.' . $i) == '-1' ? 'selected' : '' }}>Reduce FOS</option>
                                                    <option value="1" {{ old('fosa_action.' . $i) == '1' ? 'selected' : '' }}>Increase FOS</option>
                                                </select>
                                            </td>
                                            <td>
                    ...
                    <div class="mt-4">
                        ...
                        <ul>
                            ...
                            <li>The action field indicates whether FOSAs are being increased or reduced.</li>
