        ...
        <div class="col-md-12 mb-4">
            <div class="card text-start">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('transfer.member.shares') }}" method="POST" autocomplete="off">
                        @csrf
                    ...
                    <div class="mt-4">
                        ...
                        <ul>
                            ...
                            <li>The amount field should be valid and not empty if both member names are entered.</li>
