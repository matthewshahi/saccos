...
@section('content')
    <div class="breadcrumb d-flex justify-content-between align-items-center">
        <h1>Transfer Member Capital Shares</h1>
        ...
        <div class="col-md-12 mb-4">
            <div class="card text-start">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('transfer.member.capital.shares') }}" method="POST" autocomplete="off">
                        @csrf
                    ...
                    <div class="mt-4">
                        ...
                        <ul>
                            <li>Ensure all member names are correctly entered.</li>
                            <li>All fields marked with an asterisk (*) are mandatory.</li>
                            <li>Only records with full information will be processed.</li>
                            <li>Default share CAPITAL account will be credited/debited.</li>
                        </ul>
                    </div>
                </div>
            </div>
