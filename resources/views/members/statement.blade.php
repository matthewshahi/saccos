                ...
                <tbody>
                    ...
                    @foreach($data['capitalContributions'] as $i => $r)
                        ...
                        <tr>
                            ...
                            <td class="text-end">{{ $r->share_capitalamount_paying < 0 ? number_format(-$r->share_capitalamount_paying,2) : '' }}</td>
                            <td class="text-end">{{ $r->share_capitalamount_paying > 0 ? number_format($r->share_capitalamount_paying,2) : '' }}</td>
                ...
                <tbody>
                    ...
                    @foreach($data['shareContributions'] as $i => $r)
                        ...
                        <tr>
                            ...
                            <td class="text-end">{{ $r->share_amount_paying < 0 ? number_format(-$r->share_amount_paying,2) : '' }}</td>
                            <td class="text-end">{{ $r->share_amount_paying > 0 ? number_format($r->share_amount_paying,2) : '' }}</td>
                ...
                <div class="loan-box mb-4 p-3 border rounded">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-sm mb-0">
                            <thead class="bg-light">
                                <tr>
                                    <th>#</th><th>Period</th><th>Date</th><th>Doc No</th>
                                    <th>Description</th>
                            ...
                            <tbody>
                                ...
                                @foreach($loanPayments as $i => $p)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">{{ number_format($p->loan_payments_interest,2) }}</td>
                                        <td class="text-end">{{ number_format($p->loan_payments_amount + $p->loan_payments_interest,2) }}</td>
...
<style>
    ...
    .statement-sections .card { border-radius: 10px; overflow: hidden; }
    .card-header { font-size: 1rem; letter-spacing: 0.3px; }
