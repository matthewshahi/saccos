...
<div class="container">
    ...
    <strong>Note:</strong> The junior member will remain <em>inactive</em> until their account is reviewed and approved by the SACCO.
</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="member_national_id" class="form-control @error('member_national_id') is-invalid @enderror" value="{{ old('member_national_id') }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" name="member_dob" class="form-control @error('member_dob') is-invalid @enderror" value="{{ old('member_dob') }}" required>
                            @error('member_dob')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="member_gender" class="form-control @error('member_gender') is-invalid @enderror" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="member_phone_no" class="form-control @error('member_phone_no') is-invalid @enderror" value="{{ old('member_phone_no') }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email" name="member_email" class="form-control @error('member_email') is-invalid @enderror" value="{{ old('member_email') }}">
                            @error('member_email')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
