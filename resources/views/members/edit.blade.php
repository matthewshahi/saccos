...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <select class="form-control" id="member_is_junior" name="member_is_junior">
            <option value="0" {{ old('member_is_junior', $data['member']->member_is_junior) == 0 ? 'selected' : '' }}>No</option>
            <option value="1" {{ old('member_is_junior', $data['member']->member_is_junior) == 1 ? 'selected' : '' }}>Yes</option>
        </select>
    </div>
</div>
    ...
    <div class="col-sm-10">
        <select class="form-control" id="member_guardian_id" name="member_guardian_id">
            ...
            @foreach($allMembers as $guardian)
                <option value="{{ $guardian->member_id }}" {{ old('member_guardian_id', $data['member']->member_guardian_id) == $guardian->member_id ? 'selected' : '' }}>
...
<div class="form-group row">
    <label for="member_active" class="col-sm-2 col-form-label">Is Active?</label>
    <div class="col-sm-10">
        <select class="form-control" id="member_active" name="member_active">
            <option value="Y" {{ old('member_active', $data['member']->member_active) == 'Y' ? 'selected' : '' }}>Yes</option>
            <option value="N" {{ old('member_active', $data['member']->member_active) == 'N' ? 'selected' : '' }}>No</option>
        </select>
    </div>
</div>

<div class="form-group row">
    <label for="member_deleted" class="col-sm-2 col-form-label">Is Deleted?</label>
    <div class="col-sm-10">
        <select class="form-control" id="member_deleted" name="member_deleted">
            <option value="N" {{ old('member_deleted', $data['member']->member_deleted) == 'N' ? 'selected' : '' }}>No</option>
            <option value="Y" {{ old('member_deleted', $data['member']->member_deleted) == 'Y' ? 'selected' : '' }}>Yes</option>
        </select>
    </div>
</div>
