...
@section('content')
    ...
    @php
        ...
        */
        ...
        $currentFinancialPeriod =
            $statementGeneratedAt->format('Ym');

        $currentFinancialPeriodDisplay =
            $statementGeneratedAt->format('M Y');
        ...
        | interest_to_pay
        | amount_to_pay
        | interest_paid_this_period
        |
        */

        $outstandingLoans = collect(
        ...
        */
        ...
        $activeGuaranteesProvided = collect(
            $loansGuaranteed
        )
            ->filter(function ($loan) use ($threshold_amount) {
        ...
        |--------------------------------------------------------------------------
        |
        | Prefer actual loan/disbursement date.
        | Fall back to YYYYMM period.
        |
        */
    ...
    <style>
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | Eight fields = two clean rows of four on desktop.
        |
        */
        ...
        .mfs-loan-stat:nth-child(4n) {
            border-right: 0;
        }

        .mfs-loan-stat:nth-last-child(-n+4) {
            border-bottom: 0;
        }

        .mfs-loan-stat.is-payable {
            background: #faf8fc;
        }
        ...
        .mfs-loan-stat-value.is-payable {
            color: var(--mfs-accent);
            font-size: 14px;
        }
        ...
        */
        ...
        .mfs-member-panel {
            grid-template-columns:
                minmax(280px, 1.05fr) 2fr !important;
        }
        ...
        */
        ...
        @media (max-width: 767.98px) {
            ...
            .mfs-position-group {
                border-right: 0;
                border-bottom:
                    1px solid var(--mfs-border-strong);
            }
            ...
            /*
            |--------------------------------------------------------------------------
            | Two loan fields per row on tablet/mobile
            |--------------------------------------------------------------------------
            */
            ...
            .mfs-loan-stat:nth-last-child(-n+2) {
                border-bottom: 0;
            }
        ...
        @media (max-width: 480px) {
            ...
            .mfs-loan-stat:nth-last-child(-n+2) {
                ...
                border-bottom:
                    1px solid var(--mfs-border) !important;
            }

            .mfs-loan-stat:last-child {
        ...
        >
            ...
            <section class="mfs-section">
                ...
                <div class="mfs-section-head">
                    ...
                    <div class="mfs-section-description">
                        ...
                        Current balances, outstanding principal,
                        current loan obligations and financial exposure
                        recorded against this member.
                ...
                <div class="mfs-position-groups">
                    ...
                    <div class="mfs-position-group">
                        ...
                        <div class="mfs-position-item">
                            ...
                            <div class="mfs-position-value is-payable">

                                KES

                                {{ number_format(
                                    $memberFinancials['total_amount_to_pay']
                                    ?? $memberFinancials['unpaid_loan'],
                                    2
                                ) }}
                            ...
                            <div class="mfs-position-note">
                                ...
                                Includes applicable current-period
                                interest where not already serviced.
            ...
            <section class="mfs-section">
                ...
                <div class="mfs-section-head">
                    ...
                    <div class="mfs-section-description">
                        ...
                        Outstanding member loans showing principal
                        balances separately from the current amount
                        payable, together with the guarantors currently
                        securing each facility.
                ...
                @if ($outstandingLoans->isNotEmpty())
                    ...
                    @foreach ($outstandingLoans as $loan)
                        ...
                        @php
                            ...
                            /*
                            |--------------------------------------------------------------------------
                            | Loan financial position supplied by controller
                            |--------------------------------------------------------------------------
                            */
                        ...
                        <article class="mfs-loan">
                            ...
                            <div class="mfs-loan-overview">
                                ...
                                <div class="mfs-loan-grid">
                                    ...
                                    <div class="mfs-loan-stat">
                                        ...
                                        @if ($interestPaidThisPeriod)
                                            ...
                                            <div class="mfs-position-note">
                                                ...
                                                Interest already serviced
                                                in {{ $currentFinancialPeriodDisplay }}

                                            </div>

                                        @elseif ($interestToPay > 0)

                                            <div class="mfs-position-note">

                                                Current applicable interest
                                    ...
                                    <div class="mfs-loan-stat is-payable">

                                        <div class="mfs-loan-stat-label">
                                            Amount to Pay
                                        </div>

                                        <div class="mfs-loan-stat-value is-payable">
                            ...
                            <div class="mfs-guarantee-area">
                                ...
                                @else
                                    ...
                                    <div class="mfs-empty">
                                        ...
                                        No guarantors are currently attached
                                        to this loan.
            ...
            <section class="mfs-section">
                ...
                <div class="mfs-section-head">
                    ...
                    <div class="mfs-section-description">
                        ...
                        Outstanding loan obligations for which this
                        member's savings are currently pledged as
                        security.
                ...
                @else
                    ...
                    <div class="mfs-empty">
                        ...
                        This member is not currently guaranteeing
                        an outstanding loan.
            ...
            <footer class="mfs-footer">
                ...
                <div class="mfs-footer-note">
                    ...
                    Outstanding principal represents the remaining
                    principal balance on the member's loans.

                    Current amount to pay includes applicable
                    current-period interest where that interest
                    has not already been serviced.

                    Financial balances shown reflect the current
                    records in the SACCO system at the time this
        ...
        document.addEventListener(
            ...
            function() {
                ...
                */
                ...
                function getKeepTogetherRanges(
                    canvas,
                    maxPageHeightPx
                ) {
