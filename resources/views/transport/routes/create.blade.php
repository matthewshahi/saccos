...
<div class="row">
  <div class="col-md-12">
    <div class="card mb-4">
      <div class="card-body">
        <div class="card-title mb-3">Add Matatu Route</div>
        ...
        <form action="{{ route('routes.store') }}" method="POST">
          ...
          <div class="row">
            <div class="col-md-6 form-group mb-3">
              ...
              <input type="text" name="route_name" id="route_name" class="form-control" value="{{ old('route_name') }}" required>
            </div>

            <div class="col-md-6 form-group mb-3">
              <label for="route_distance_km">Distance (KM)</label>
              <input type="number" name="route_distance_km" id="route_distance_km" step="0.01" class="form-control" value="{{ old('route_distance_km') }}">
            </div>

            <div class="col-md-6 form-group mb-3">
              <label for="route_start">Start Point</label>
              <input type="text" name="route_start" id="route_start" class="form-control" value="{{ old('route_start') }}" required>
            </div>

            <div class="col-md-6 form-group mb-3">
              <label for="route_end">End Point</label>
              <input type="text" name="route_end" id="route_end" class="form-control" value="{{ old('route_end') }}" required>
            </div>
            ...
            <div class="col-md-12">
              ...
              <a href="{{ route('routes') }}" class="btn btn-secondary">Cancel</a>
            </div>
          </div>
        </form>
