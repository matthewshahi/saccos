    ...
    <div class="alert alert-danger">
        <ul class="mb-0">
            @foreach ($errors->all() as $error)
                <li>{!! nl2br(e($error)) !!}</li> <!-- Converts line breaks in error messages to HTML <br> tags -->
            @endforeach
        </ul>
    </div>
@endif
...
@if (session('success'))
    <div class="alert alert-success">
        {!! nl2br(e(session('success'))) !!} <!-- Converts line breaks in success message -->
    </div>
@endif
...
@endif
    ...
    <div class="card">
        <div class="card-body">
        <form action="{{ route('loans.process.application') }}" method="POST" enctype="multipart/form-data">
        @csrf
    ...
    <div class="row">
        <div class="col-md-6 form-group mb-3">
            ...
            <input class="form-control" id="batch_trans_member_name" name="batch_trans_member_name" 
                   type="text" value="{{ $loan->member_name }} - ({{ $loan->member_sacco_id }})" readonly>
        </div>
        ...
        <div class="col-md-6 form-group mb-3">
            ...
            <input class="form-control" id="batch_trans_loan_amount" name="batch_trans_loan_amount" 
                   type="text" value="{{ old('batch_trans_loan_amount', $loan->batch_trans_loan_amount) }}">
        </div>
        <div class="col-md-6 form-group mb-3">
        ...
        <div class="col-md-6 form-group mb-3">
            ...
            <input class="form-control" id="batch_trans_description" name="batch_trans_description" 
                   type="text" value="{{ old('batch_trans_description', $loan->batch_trans_description) }}" maxlength="50">
        </div>
        <div class="col-md-6 form-group mb-3">
    ...
    <div class="card mt-4">
    <div class="card-body">
    <h4 class="card-title">Add New Guarantors (Max 3)</h4>
