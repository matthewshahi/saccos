                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="position-relative">
                                                    <input
                                                        type="text"
                                                        name="guarantors_guarantor_name[{{ $i }}]"
                                                        class="form-control"
                                                        placeholder="Search guarantor by name"
                                                        onkeyup="showHintMembers(this.value, 'guarantors_guarantor_name[{{ $i }}]', 'suggestions_{{ $i }}')"
                                                        autocomplete="off"
                                            ...
                                            <td>
                                                <input
                                                    type="number"
                                                    name="guarantors_amount_guaranteed[{{ $i }}]"
                                                    class="form-control"
                                                    placeholder="Amount"
                                                    min="1"
                                                    step="0.01"
                                                    value="{{ old('guarantors_amount_guaranteed.'.$i) }}"
                                                >
                                            </td>
                                        </tr>
                                    @endfor
