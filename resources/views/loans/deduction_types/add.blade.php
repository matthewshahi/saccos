...
@section('title', 'Add Loan Deduction Type')

@section('content')
<div class="breadcrumb">
    <h1>Add Loan Deduction Type</h1>
    <ul>
        ...
        <div class="card">
            <div class="card-body d-flex justify-content-between align-items-center flex-wrap gap-2 py-3">
                <div>
                    ...
                    <small class="text-muted">Create and manage reusable loan deductions.</small>
                </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <form action="{{ route('loans.deduction-types.store') }}" method="POST">
            @csrf
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 form-group mb-3">
                            <label for="deduction_type_name">
                                Deduction Type Name <span class="text-danger">*</span>
                            </label>
                            <input
                                type="text"
                        ...
                        <div class="col-md-4 form-group mb-3">
                            <label for="deduction_type_value_type">
                            ...
                            <select
                                ...
                                required
                            >
                                <option value="FIXED" {{ old('deduction_type_value_type', 'FIXED') === 'FIXED' ? 'selected' : '' }}>
                                    Fixed Amount
                                </option>
                                <option value="PERCENT" {{ old('deduction_type_value_type') === 'PERCENT' ? 'selected' : '' }}>
                                    Percent
                                </option>
                            </select>
                        ...
                        <div class="col-md-4 form-group mb-3">
                            <label for="deduction_type_default_value">
                            ...
                            <input
                                ...
                                value="{{ old('deduction_type_default_value', 0) }}"
                                required
                            >
                        ...
                        <div class="col-md-4 form-group mb-3">
                            <label for="deduction_type_effect">
                                Effect <span class="text-danger">*</span>
                            </label>
                            <select
                                ...
                                required
                            >
                                <option value="ADD_TO_LOAN" {{ old('deduction_type_effect') === 'ADD_TO_LOAN' ? 'selected' : '' }}>
                                    Add to Loan
                                </option>
                                <option value="DEDUCT_FROM_DISBURSEMENT" {{ old('deduction_type_effect', 'DEDUCT_FROM_DISBURSEMENT') === 'DEDUCT_FROM_DISBURSEMENT' ? 'selected' : '' }}>
                            ...
                            >
                                ...
                                @foreach($incomeLiabilityAccounts as $acc)
                                    <option value="{{ $acc->sub_account_id }}"
                                        {{ (string) old('deduction_type_account') === (string) $acc->sub_account_id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-12 form-group mb-3">
                            ...
                            >{{ old('deduction_type_description') }}</textarea>
                        ...
                        <div class="col-md-12 form-group mb-3">
                            <div class="form-check">
                                <input
                                    ...
                                    {{ old('deduction_type_active', 1) ? 'checked' : '' }}
                                >
