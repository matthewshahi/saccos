                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 form-group mb-3">
                            ...
                            <select class="form-control" id="loan_type_insurance_effect" name="loan_type_insurance_effect">
                                ...
                                <option value="ADD_TO_LOAN" {{ old('loan_type_insurance_effect') == 'ADD_TO_LOAN' ? 'selected' : '' }}>Add to Loan</option>
                                <option value="DEDUCT_FROM_DISBURSEMENT" {{ old('loan_type_insurance_effect') == 'DEDUCT_FROM_DISBURSEMENT' ? 'selected' : '' }}>Deduct from Amount Disbursed</option>
                            </select>
