                ...
                <form action="{{ route('loans.batch.transactions.add', $batch->batch_id) }}" method="POST" autocomplete="off">
                    ...
                    <div class="form-group row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" id="member" name="batch_trans_member_id" class="form-control @error('batch_trans_member_id') is-invalid @enderror" onkeyup="showHintMembers(this.value)" autocomplete="off" required value="{{ old('batch_trans_member_id') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="batch_trans_loan_amount" id="loan_amount" class="form-control @error('batch_trans_loan_amount') is-invalid @enderror" required value="{{ old('batch_trans_loan_amount') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="batch_trans_commission_amount" id="commission_amount" class="form-control @error('batch_trans_commission_amount') is-invalid @enderror" value="{{ old('batch_trans_commission_amount') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="batch_trans_loan_duration" id="loan_duration" class="form-control @error('batch_trans_loan_duration') is-invalid @enderror" required value="{{ old('batch_trans_loan_duration') }}">
...
@enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="batch_trans_doc_no" id="doc_no" class="form-control @error('batch_trans_doc_no') is-invalid @enderror" required value="{{ old('batch_trans_doc_no') }}">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="batch_trans_description" id="description" class="form-control @error('batch_trans_description') is-invalid @enderror">{{ old('batch_trans_description') }}</textarea>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <table class="table table-bordered" id="guarantors-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" name="guarantors[{{ $i }}][member]" class="form-control guarantor-member @error('guarantors.'.$i.'.member') is-invalid @enderror" onkeyup="showHintGuarantor(this.value, {{ $i }})" autocomplete="off" value="{{ old('guarantors.'.$i.'.member') }}">
                                        ...
                                        <td>
                                            <input type="text" name="guarantors[{{ $i }}][amount]" class="form-control @error('guarantors.'.$i.'.amount') is-invalid @enderror" value="{{ old('guarantors.'.$i.'.amount') }}">
                                        ...
                                        <td>
                                            <input type="text" name="guarantors[{{ $i }}][free_shares]" class="form-control guarantor-free-shares" readonly value="{{ old('guarantors.'.$i.'.free_shares') }}">
                                        </td>
                                        <td>
