...
<div class="row">
                ...
                <div class="dropdown dropleft text-end w-50 float-end">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton_tb">
                        <a class="dropdown-item"
                           href="{{ route('reports.final_accounts.trial_balance.pdf', request()->query()) }}">Download PDF</a>
                        <a class="dropdown-item"
                           href="{{ route('reports.final_accounts.trial_balance.excel', request()->query()) }}">Download Excel</a>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('reports.final_accounts.trial_balance') }}">
                    <div class="row g-3 align-items-end">
                        ...
                        {{-- RUN --}}
                        <div class="col-12 col-md-3">
                            <button class="btn btn-primary w-100 py-3 fw-bold" type="submit" style="border-radius:12px;">
                                <i class="nav-icon i-Search-People me-2"></i> Run Report
                            </button>
                            <small class="text-muted d-block mt-1 text-center">Generates totals + lines instantly.</small>
                        </div>
    ...
    <div class="col-md-12">
        <div class="card o-hidden mb-4">
            ...
            @php
                // DO NOT override $rows here. Just read what controller passed.
                $groupOf = function ($t) {
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table text-center table-sm">
                        ...
                        @if(isset($rows) && $rows instanceof \Illuminate\Support\Collection ? $rows->count() > 0 : (is_countable($rows ?? null) && count($rows) > 0))
                            <tfoot>
