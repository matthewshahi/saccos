    ...
    <div class="col-md-12">
        <div class="card mb-4">
            <div class="card-body">
                ...
                <p>Hello, <strong>{{ $member->first_name }}</strong>. We are excited to have you join our SACCO!</p>
                <p>To complete your registration, kindly provide the additional documents listed below:</p>
                <ul>
