        ...
        public function submit(Request $request)
{
    ...
    $validator = Validator::make($request->all(), [
        ...
        'phone' => 'required|string|max:15|unique:sacco_members_new_applications,phone',
    ...
    // Ensure total kin share percentage does not exceed 100%
    ...
    return redirect()->route('register.form')->with('success', 'Registration successful! All details and documents have been saved.');
}
