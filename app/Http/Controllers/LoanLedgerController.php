                    ...
                    public function importLoansToLedger()
                    {
                        ...
                        $loans = [
                            [
                                ...
                                "loan_amount" => 1262500.00,
                                "loan_insurance" => 12500.00,
                                "loan_commision" => 0,
                                ...
                                "loan_loan_paid" => 0,
                                "loan_doc_no" => "Loan Top Up",
                                "loan_description" => "Self Applied Loan-2513-KISILU, CHRISTINE MUTHEU",
                                "loan_batch_no" => "Self Applied Loan-2513-KISILU, CHRISTINE MUTHEU",
